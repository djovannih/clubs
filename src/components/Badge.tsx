...
export default function Badge({ active, children }: BadgeProps) {
  return (
    <span
      className={clsx(
        "absolute right-0 top-0 flex h-6 w-6 -translate-y-1/2 translate-x-1/2 transform items-center justify-center rounded-full bg-slate-800 text-xs font-bold ring-1",
